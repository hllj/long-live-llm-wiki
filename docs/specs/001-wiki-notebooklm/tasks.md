...
## Phase 2b — Rewrite `wiki-nlm-sync` (v1.1.0)  `[P with Phase 3b]`

### T22 — Rewrite `skills/wiki-nlm-sync/SKILL.md`

Overwrite `/Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-sync/SKILL.md` with the full v1.1.0 content (see Phase 2b in plan.md). The rewrite adds: proactive auth check, authenticate sub-workflow, discover sub-workflow, drive-sync sub-workflow, source describe in pull, profile support.

See T08 for the prior version. The new file must contain all prior workflows **plus** the additions below.
...
### T23 — Verify `wiki-nlm-sync` v1.1.0 content

```bash
grep "Authenticate workflow" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-sync/SKILL.md
grep "Discover workflow" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-sync/SKILL.md
grep "Drive-sync workflow" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-sync/SKILL.md
grep "nlm login --check" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-sync/SKILL.md
grep "nlm source describe" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-sync/SKILL.md
```

Expected: all five greps return matches.

---

## Phase 3b — Rewrite `wiki-nlm-research` (v1.1.0)  `[P with Phase 2b]`

### T24 — Rewrite `skills/wiki-nlm-research/SKILL.md`

Overwrite `/Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-research/SKILL.md` with the full v1.1.0 content. Adds: proactive auth check, source describe before pull, profile support in auth messages.
...
### T25 — Verify `wiki-nlm-research` v1.1.0 content

```bash
grep "nlm login --check" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-research/SKILL.md
grep "nlm source describe" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-research/SKILL.md
grep "profile" /Users/hllj/Projects/LLM-Wiki-Notebook/skills/wiki-nlm-research/SKILL.md
```
...
### T26 — Commit v1.1.0 SKILL.md rewrites
...
feat(wiki-nlm): v1.1.0 — add auth, discover, drive-sync, source-describe

- wiki-nlm-sync: proactive auth check, authenticate sub-workflow, discover
  sub-workflow (nlm research), drive-sync sub-workflow, source describe in pull
- wiki-nlm-research: proactive auth check, source describe before pull, profile hints
- spec bumped to v1.1.0 with FR-7–FR-11 and US-8–US-12
